export const PRIMARY_MAIN = '#8055c2';

export const PRIMARY_LIGHTER = '#ccbbe7'

export const PATH_AFTER_AUTH = '/home';

export const SERVER_URL = process.env.EXPO_PUBLIC_SERVER_URL

export const DEFAULT_PROFILE = 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_640.png';
